...
function filter() {
		...
		document.getElementById("content").innerHTML = `
         ...
         <div class="container">
            ...
            <div class="pedagogisch-1">
                <h2>Pedagogisch Project <img src="images/icon_flyer.png" class="educational-icon"></h2>
            ...
            <div class="pedagogisch-2">
                <h2>Voel je het al kriebelen?<img src="images/icon-kriebels.png" class="kriebels-icon" /></h2>
            ...
            <div class="pedagogisch-3">
                ...
                <h2>En wat met al die juffen en meesters?<img src="images/icon_Juf_meesters.png" class="teachers-icon" /></h2>
            ...
            <div class="pedagogisch-4">
                <h2>Voorbereid op een complexe wereld?<img src="images/icon_complexe.png" class="complex-icon" /></h2>
            ...
            <div class="pedagogisch-5">
                <h2>Best uitdagend?<img src="images/Icon_uitdagend.png" class="challenging-icon"></h2>
            ...
            <div class="pedagogisch-6">
                <h2>Maar toch niet elk kind kan dat?<img src="images/Icon_maar.png" class="but-icon"></h2>
            ...
            <div class="pedagogisch-7">
                <h2>En zijn er dan geen regels meer op school?<img src="images/Icon_geen_regels.png" class="rules-icon"></h2>
    ...
    <div class="container">
		...
		<div class="orientatie-1">
			<!-- <div class="o-title-1"> -->
				<h2>Mens <img src="images/icon_mens.png" class="human-icon"></h2>
			<!-- </div> -->
		...
		<div class="orientatie-2">
			<div class="o-title-2">
				<h2>Maatschappij <img src="images/Icon_maatschappij_ samen.png" class="society-icon"></h2>
			</div>
		...
		<div class="orientatie-3">
			<div class="o-title-3">
				<h2>Ruimte: verkeer en mobiliteit <img src="images/Icon_mobiliteit.png" class="mobility-icon"></h2>
			</div>
			<div class="o-vakje-3">
		...
		<div class="orientatie-4">
			...
			<div class="o-title-4">
				<h2>Tijd <img src="images/icon_clock.png" alt="clock-icon"></h2>
			</div>
			<div class="o-vakje-4">
		...
		<div class="orientatie-5">
			...
			<div class="o-title-5">
				<h2>Natuur: levende natuur <img src="images/Icon_levend.png" class="nature-icon"></h2>
			</div>
			<div class="o-vakje-5">
		...
		<div class="orientatie-6">
			<div class="o-title-6">
				<h2>Natuur: gezondheid <img src="images/Icon_gezondheid.png" class="health-icon"></h2>
			</div>
			<div class="o-vakje-6">
		...
		<div class="orientatie-7">
			...
			<div class="o-title-7">
				<h2>Natuur: Milieu <img src="images/Icon_milieu.png" class="milieu-icon"></h2>
			</div>
			<div class="o-vakje-7">
		...
		<div class="orientatie-8">
			<div class="o-title-8">
				<h2>Techniek <img src="images/Icon_techniek.png" class="technology-icon"></h2>
			</div>
			<div class="o-vakje-8">
	...
	document.querySelector(".button-3").addEventListener("click", function () {
		...
		<div class="lerlev-1">
			...
			<div class="l-title-1">
				<h2>Samen <img src="images/Icon_maatschappij_ samen.png" class="together-icon"></h2>
			</div>
			<div class="l-vakje-1">
		...
		<div class="lerlev-2">
			<div class="l-title-2">
				<h2>Creatief <img src="images/Icon_createif.png" class="creativ-icon"></h2>
			</div>
			<div class="l-vakje-2">
		...
		<div class="lerlev-3">
			<div class="l-title-3">
				<h2>Positief <img src="images/Icon_positief.png" class="positiv-icon"></h2>
			</div>
		...
		<div class="lerlev-4">
			<div class="l-title-4">
				<h2>De lat van elk kind hoog <img src="images/Icon_ladder_hoog.png" class="ladder-icon"></h2>
			</div>
		...
		<div class="lerlev-5">
			...
			<div class="l-title-5">
				<h2>Open <img src="images/Icon_open.png" class="open-icon"></h2>
			</div>
			<div class="l-vakje-5">
		...
		<div class="lerlev-6">
			...
			<div class="l-title-6">
				<h2>Veilig <img src="images/Icon_veiligheid.png" class="safe-icon"></h2>
			</div>
			<div class="l-vakje-6">
